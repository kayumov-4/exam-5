...
const index = () => {
  ...
  return (
    <section className={` ${theme == "dark" && "!bg-[#030712]"} `} id="intro">
      <div className="container">
        <div className="wrapper">
          <div className="wrapper_left">
            ...
            <p
              className={`wrapper_left_desc ${
                theme == "dark" && "!text-white"
              } `}
            >
              I'm a full stack developer (React.js & Vue.js and Node.js &
              Laravel ) with a focus on creating exceptional digital experiences
              that are fast, accessible, visually appealing, and responsive.
              Even though I have been creating web applications for over 7
              years, I still love it as if it was something new.
            </p>
            <div className="infos">
              <div className="wrapper_left_info">
                <svg
              ...
              <div className="wrapper_left_icons">
                <a href="#">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
