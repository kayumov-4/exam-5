...
import CopyToClipboardButton2 from "../UI/CopyToClipboardButton2";
import { ThemeContext } from "../../context/ThemeContext";

const index = () => {
  const { theme, setTheme } = useContext(ThemeContext);
  return (
    <section className={`${theme == "dark" && "bg-[#030712]"}`}>
          ...
          <div>
            <div className="flex items-center justify-center flex-col mb-[48px]">
              ...
              <div className="flex flex-col gap-[48px]">
                <p
                  className={`text-[20px] leading-[28px] text-[#4B5563] max-w-[576px] text-center mt-4 ${
                  ...
                  <div className="flex items-center justify-center gap-[20px]">
                    ...
                    >
                      ...
                      <p
                        className={`${
                          theme == "dark" && "text-white"
                        } text-[36px] font-[Semibold] tracking-[-0.72px] leading-[40px]`}
                      >
                        +998 99 014 99 98
                      </p>
                    </a>
